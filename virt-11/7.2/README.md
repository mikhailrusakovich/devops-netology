...
![](/Users/mikhailrusakovich/Documents/Screen Shot 2022-01-04 at 8.23.31 PM.png)

![](/Users/mikhailrusakovich/Documents/Screen Shot 2022-01-04 at 8.26.30 PM.png)

В виде результата задания приложите вывод команды `aws configure list`.

```commandline
mikhailrusakovich@Mikhails-MacBook-Pro 7.2 % aws configure list
...
Ответ на вопрос: при помощи какого инструмента (из разобранных на прошлом занятии) можно создать свой образ ami? <br>

Packer - инструмент, с помощью которого можно создать свой собственный образ ami. CLoudFormation тоже можем использовать.<br>
